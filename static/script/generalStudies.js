        ...
        let courseHtml = `
            <div class="min-[930px]:flex items-center justify-around p-2 my-2 bg-white rounded-xl">
                ...
                <div class="flex justify-center">
                    <a href="${courseData[i].courseIntroduceUrl}" target="_blank" class="p-5 m-3 text-gray-600 font-bold text-lg rounded-lg cursor-pointer bg-backgroundGreen">課程大綱</a>
                </div>
            </div>
        `;
